...
use crate::resource::{loader::FluentLoader, LangResource};
...
impl<'a> LangResource<'a> {
    ...
    ///
    /// ```no_run
    /// use glossa::resource::{loader::static_loader, LangResource};
    ///
    /// static_loader! {
    ///     static L10N_LOADER = {
    ///         locales: "locales",
    ...
    /// ```
    ///
    /// See also [`new_arc_loader()`](crate::resource::loader::new_arc_loader)
    ...
    pub fn with_arc_owned(id: LangID, loader: ArcLoader) -> Self {
        Self {
            id,
            loader: FluentLoader::ArcOwned(loader.into()),
            chain: OnceCell::new(),
        }
    }
...
mod tests {
    ...
    #[test]
    fn new_language_resource() -> crate::Result<()> {
        use crate::{
            resource::loader::{new_arc_loader, ArcLoader},
            LangRes,
        };
        ...
        // use glossa::{resource::loader::new_arc_loader, LangRes};
    ...
    fn test_from_static_loader() {
        use crate::resource::{loader::static_loader, LangResource};
